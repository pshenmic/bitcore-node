...
function addService(configDir, service, done) {
  if (service === 'insight-ui') {
    service = 'git://github.com/tark-industries/insight.git#5.0';
  }
  if (service === 'insight-api') {
    service = 'git://github.com/tark-industries/insight-api.git';
  }
